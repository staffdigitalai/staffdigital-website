    ...
    <section className="py-28 sm:py-36 px-6 sm:px-8 relative overflow-hidden">
      <div className="max-w-3xl mx-auto relative">
        ...
        <div className="space-y-8">
          ...
          <div className="relative py-6 px-6 sm:px-8 rounded-2xl bg-foreground/[0.02] dark:bg-white/[0.03] border-l-[3px] border-[#0078AA] dark:border-[#00D4FF]">
            <p className="text-foreground/90 font-semibold text-lg sm:text-xl leading-relaxed">
              {t("p2")}
            </p>
          </div>
