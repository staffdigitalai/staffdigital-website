...
const fallbackSectors: WPSectorPage[] = [
  ...
  },
  {
    ...
    excerpt: { rendered: "<p>Reservas automaticas, pedidos a domicilio y atencion al cliente sin interrupciones.</p>" },
    content: { rendered: "" },
    featured_media: 0,
    menu_order: 4,
    acf: {
  ...
  },
  {
    ...
    excerpt: { rendered: "<p>Atencion al cliente omnicanal, gestion de pedidos y soporte postventa automatizado.</p>" },
    content: { rendered: "" },
    featured_media: 0,
    menu_order: 8,
    acf: {
  ...
  },
  {
    ...
    excerpt: { rendered: "<p>Recepcion virtual, gestion de visitas y atencion telefonica inteligente.</p>" },
    content: { rendered: "" },
    featured_media: 0,
    menu_order: 9,
    acf: {
  ...
  },
  {
    ...
    excerpt: { rendered: "<p>Gestion de incidencias, programacion de visitas y soporte tecnico automatizado.</p>" },
    content: { rendered: "" },
    featured_media: 0,
    menu_order: 10,
    acf: {
  ...
  },
  {
    ...
    excerpt: { rendered: "<p>Atencion a alumnos, gestion de matriculas e informacion sobre cursos 24/7.</p>" },
    content: { rendered: "" },
    featured_media: 0,
    menu_order: 11,
    acf: {
  ...
  },
  {
    ...
    excerpt: { rendered: "<p>Seguimiento de pedidos, gestion de incidencias y comunicacion con clientes automatizada.</p>" },
    content: { rendered: "" },
    featured_media: 0,
    menu_order: 12,
    acf: {
