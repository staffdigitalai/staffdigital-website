...
export function GimnasiosClient() {
  const conversations = getConversationsForSector("gimnasios")
        ...
        <div className="relative z-10">
          ...
          {conversations.length > 0 && (
            <ConversationSimulator
              title="Tu IA Atendiendo Socios"
              subtitle="Mira como nuestros asistentes gestionan reservas de clases y consultas de socios."
