...
const data: SectorPageData = {
  ...
  subheadline: "Automatiza la atencion al cliente en tu comercio, responde consultas sobre productos, stock y pedidos 24/7 en todos tus canales.",
  ...
  painPoints: [
    ...
    { icon: BarChart3, title: "Sin datos de cliente", description: "Pierdes informacion valiosa sobre preferencias y comportamiento de compra." },
  ],
  features: [
    { icon: Headphones, title: "Asistente de Ventas IA 24/7", description: "Responde preguntas sobre productos, tallas, colores, disponibilidad y precios en tiempo real. Sugiere articulos complementarios para aumentar el ticket medio.", highlight: "Aumento del 25% en ventas cruzadas" },
    { icon: Package, title: "Gestion de Pedidos Automatica", description: "Informa sobre el estado de envios, gestiona devoluciones y procesa cambios automaticamente en todos tus canales de venta." },
    ...
    { icon: TrendingUp, title: "Analisis de Comportamiento", description: "Detecta tendencias de compra, productos mas consultados y motivos de abandono para optimizar tu estrategia comercial." },
  ],
  stats: [
  ...
  ctaDescription: "Unete a comercios que ya venden mas con atencion automatizada e inteligente.",
}
