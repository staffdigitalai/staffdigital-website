    ...
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-sm font-medium mb-8 mt-12 animate-fade-in-badge gap-2">
          ...
          <span className="text-emerald-400 font-semibold">Voz Humana HD</span>
          <span className="text-white/40">·</span>
          <span className="text-white/60">Plataforma Omnicanal Gestionada</span>
        </div>
        ...
        <p className="text-base sm:text-lg md:text-xl text-white/60 mb-4 animate-fade-in-heading font-light">
          Agentes IA que escuchan, responden y actúan en tu CRM. Nosotros implementamos, integramos y gestionamos todo.
        </p>
        ...
        <div className="flex items-center justify-center gap-2 mb-8 animate-fade-in-subheading">
          <span className="text-lg sm:text-xl text-white/50 font-light">IA para</span>
          <RotatingText
            texts={["call center", "WhatsApp Business", "agendamientos", "pré-venda", "posventa"]}
