...
const data: SectorPageData = {
  ...
  painPoints: [
    ...
    { icon: AlertTriangle, title: "Información inconsistente", description: "Diferentes respuestas segun quien atienda sobre becas, extraescolares o normativa del centro." },
  ],
  features: [
    ...
    { icon: MessageSquare, title: "Atencion a Familias 24/7", description: "Responde consultas sobre horarios, menu del comedor, extraescolares, uniformes ymás a cualquier hora del dia." },
    { icon: CalendarCheck, title: "Gestión de Citas y Tutorias", description: "Agenda reuniones con tutores, entrevistas de admision y visitas al centro automaticamente.", highlight: "-60% carga administrativa" },
    { icon: BarChart3, title: "Dashboard de Comunicaciones", description: "Visualiza tasas de apertura, consultasmás frecuentes y satisfaccion de las familias en tiempo real." },
...
export function EducacionClient() {
  const conversations = getConversationsForSector("educacion")
        ...
        <div className="relative z-10">
          ...
          {conversations.length > 0 && (
            <ConversationSimulator
              title="Tu IA Atendiendo Familias"
              subtitle="Mira como nuestros asistentes gestionan consultas de inscripcion y matriculacion."
