    ...
    <PageWrapper breadcrumbs={[{ label: "Soluciones" }]}>
            ...
            {sortedServices.map((service) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {service.isFeatured && (
                      <div className="absolute -top-3 left-6 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-500 text-foreground text-xs font-semibold">
                      ...
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform ${
                          service.isFeatured
                            ...
                            : "bg-gradient-to-br from-white/10 to-white/5 border border-foreground/10"
                        }`}
                      >
                        <IconComponent
                          size={24}
                          className={service.isFeatured ? "text-orange-400" : "text-foreground/80"}
                        />
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="text-xl font-semibold text-foreground mb-1 group-hover:text-foreground/90">
                          {service.title}
                        </h3>
                        {service.subtitle && (
                          <p className="text-foreground/50 text-sm mb-3">{service.subtitle}</p>
                        )}
                        <p className="text-foreground/60 leading-relaxed text-sm line-clamp-3">
                          {service.excerpt}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 flex items-center justify-between">
                      <span
                        className={`text-sm font-medium ${
                          service.isFeatured ? "text-orange-400" : "text-foreground/70"
                      ...
                      <ArrowRight
                        size={18}
                        className={`${
                          service.isFeatured ? "text-orange-400" : "text-foreground/50"
                        } group-hover:translate-x-1 group-hover:text-foreground transition-all`}
                      />
                    </div>
                  </div>
                </Link>
      ...
      <section className="px-4 pb-20 md:pb-32">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-3xl border border-foreground/10 bg-foreground/5 backdrop-blur-sm p-8 md:p-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
              <div className="text-center">
                ...
                <p className="text-foreground/50 text-sm">Empresas confian en nosotros</p>
              </div>
              <div className="text-center">
                <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent mb-2">
                  24/7
                </p>
                <p className="text-foreground/50 text-sm">Disponibilidad total</p>
              </div>
              <div className="text-center">
                <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent mb-2">
                  -70%
                </p>
                <p className="text-foreground/50 text-sm">Reduccion de costes</p>
              </div>
              <div className="text-center">
                <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent mb-2">
                  +40%
                </p>
                <p className="text-foreground/50 text-sm">Aumento de conversiones</p>
              </div>
            </div>
          </div>
        </div>
