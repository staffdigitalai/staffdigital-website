      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-balance mb-4 sm:mb-6">
            El <span className="text-red-400">60-70%</span> de Tus Leads Se Estan Perdiendo
          </h2>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-red-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-red-400">La Realidad</h3>
              </div>

              {/* Key Stat */}
              <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-xl p-4 sm:p-6 mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-red-400 mb-2">+4 Horas</div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-white/70 text-sm sm:text-base">
                    El personal pierde consultas fuera de horario y los fines de semana
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">
                    Ocupados atendiendo clientes mientras los leads online se enfrian
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">Inversion en marketing desperdiciada en consultas sin responder</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-green-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-green-400">Nuestra Solucion</h3>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Cualifica leads al instante y agenda citas</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Se integra con tu CRM y sistema de calendario</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Funciona en web, WhatsApp, email y telefono</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            ...
            <p className="text-white/70 text-xs sm:text-sm">Valor medio por lead perdido</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">78%</div>
            <p className="text-white/70 text-xs sm:text-sm">Eligen al primero que responde</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">24/7</div>
            <p className="text-white/70 text-xs sm:text-sm">Nuestra IA nunca duerme</p>
          </div>
        </div>
