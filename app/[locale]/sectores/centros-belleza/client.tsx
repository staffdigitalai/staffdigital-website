...
const data: SectorPageData = {
  ...
  painPoints: [
    ...
    { icon: Clock, title: "Gestion manual de agenda", description: "Horas dedicadas a cuadrar horarios, estilistas y servicios en una agenda cada vezmás compleja." },
  ...
  features: [
    ...
    { icon: MessageSquare, title: "Gestión de Cancelaciones", description: "Cuando alguien cancela, la IA contacta automaticamente a clientes en lista de espera para rellenar el hueco al instante." },
    ...
    { icon: BarChart3, title: "Optimizacion de Agenda", description: "Analiza patrones de reserva, horas punta y serviciosmás demandados para maximizar la ocupacion de cada estilista.", highlight: "95% ocupacion de agenda" },
  ],
  stats: [
