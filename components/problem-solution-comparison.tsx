...
export function ProblemSolutionComparison() {
  ...
  const comparisons = [
    ...
    },
    {
      icon: MessageSquare,
      channel: "Chat Web",
      problem: "+4 horas de tiempo de respuesta",
      solution: "Respuesta instantanea",
    },
    {
      icon: MessageCircle,
      channel: "Mensajeria Social",
      problem: "+4 horas de tiempo de respuesta",
      solution: "Respuestas instantaneas en todas las redes",
    },
    {
      icon: Car,
      channel: "Visitas de Coches",
      problem: "Programacion manual, oportunidades perdidas",
      solution: "Reserva visitas por telefono, redes sociales o chat web",
    },
    {
      icon: Calendar,
      channel: "Reservas de Servicio",
      problem: "Programacion de servicio retrasada",
      solution: "Reserva y programacion instantanea",
    },
    {
      icon: Wrench,
      channel: "Consultas de Recambios",
      problem: "Presupuestos y consultas de recambios lentos",
      solution: "Comprueba stock al instante y da precio",
    },
  ]
    ...
    <section ref={sectionRef} className="relative py-16 sm:py-24">
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto">
          Mira lo que pasa cuando un cliente contacta con tu concesionario fuera de horario
        </p>
      </div>
                  ...
                  <tr className="border-b border-slate-200">
                    ...
                    <th className="text-left py-6 px-6">
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-red-50 border-l-4 border-red-500">
                        <span className="text-red-600 font-semibold">Sin StaffDigital AI</span>
                      </div>
                    </th>
                    <th className="text-left py-6 px-6">
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-green-50 border-l-4 border-green-500">
                        <span className="text-green-600 font-semibold">Con StaffDigital AI</span>
                      </div>
                    </th>
                  </tr>
                </thead>
          ...
          <div className="md:hidden space-y-4">
            ...
            <div className="backdrop-blur-sm bg-slate-50/50 rounded-xl border border-slate-200 overflow-hidden mt-6">
              <div className="p-4 border-b border-slate-200 bg-slate-50">
                <span className="text-slate-700 font-semibold text-xs uppercase tracking-wider">Impacto Anual</span>
              </div>
              <div className="grid grid-cols-2 divide-x divide-slate-200">
