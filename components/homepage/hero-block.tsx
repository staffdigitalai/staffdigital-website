  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 py-20 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10 animate-fade-in-hero">
        ...
        <div className="inline-flex items-center px-4 py-2 rounded-full bg-foreground/10 dark:bg-white/15 backdrop-blur-md border border-foreground/20 dark:border-[var(--neon-blue)]/30 text-foreground text-sm font-medium mb-8 mt-12 animate-fade-in-badge gap-2 animate-border-glow">
          ...
          <span className="text-foreground/80">{t("badge_platform")}</span>
        </div>
