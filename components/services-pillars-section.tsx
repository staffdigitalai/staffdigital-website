...
const pillars = [
  {
    ...
    description: "Agentes IA con voz humana, asistentes virtuales, agentes de voz, cualificacion de leads y reserva automatica de citas.",
    features: ["Agentes IA 24/7", "Agentes de Voz", "Cualificacion de Leads", "Reserva de Citas"],
  ...
  },
  {
    ...
    description: "Bandeja unificada, respuestas automaticas, automatización de email, CRM y flujos de trabajo integrados.",
  ...
  },
  {
    ...
    description: "Monitorizacion inteligente, deteccion de personas y vehiculos, alertas automaticas e integración con alarmas.",
    features: ["Deteccion IA", "Alertas Automaticas", "Integración Alarmas", "Dashboard Remoto"],
